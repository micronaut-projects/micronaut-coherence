 ...
 * that will receive {@link com.tangosol.net.events.partition.TransferEvent.Type#ARRIVED ARRIVED}
...
public @interface Assigned {
    ...
    class Literal extends AnnotationLiteral<Assigned> implements Assigned {
