 ...
 * that will receive {@link com.tangosol.net.events.partition.TransferEvent.Type#ASSIGNED ASSIGNED}
...
public @interface Arrived {
    ...
    final class Literal extends AnnotationLiteral<Arrived> implements Arrived {
