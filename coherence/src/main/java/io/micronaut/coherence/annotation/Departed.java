 ...
 * that will receive {@link com.tangosol.net.events.partition.TransferEvent.Type#DEPARTED DEPARTED}
...
public @interface Departed {
    ...
    class Literal extends AnnotationLiteral<Departed> implements Departed {
