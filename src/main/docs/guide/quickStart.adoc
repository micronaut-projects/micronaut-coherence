...
dependency:coherence[groupId="com.oracle.coherence.ce",version="23.09"]

NOTE: Coherence CE 23.09 and newer require JDK 17 as a minimum!

or to use a commercial version Coherence:

dependency:coherence[groupId="com.oracle.coherence",version="14.1.1-2206-6"]
